export const siteConfig = {
  ...
  whatsappMessage: 'Bonjour, je cherche un tapis a Nador. Pouvez-vous me conseiller ?',
  ...
  priceRange: 'MAD 150 - MAD 5000',
  latitude: 35.17505927275488,
  longitude: -2.9257331244318863,
